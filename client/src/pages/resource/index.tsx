          ...
          <Col xs={24}>
            <div className="w-full p-8 flex gap-4">
              <Icon
                ...
                width={36}
                height={36}
                className="hover:opacity-50 cursor-pointer dark:text-white"
          ...
          <Col md={24} lg={17} xl={18} xxl={19} className="border-t-2 border-b">
            <Row className="p-8 gap-y-4">
              ...
              <Col xs={24} md={8}>
                <button
                  type="button"
                  className="w-full h-full dark:text-white dark:bg-neutral-800 bg-gray-300 px-4 py-2 text-lg rounded-lg cursor-pointer outline-none ring-1 ring-gray-400 dark:ring-neutral-800 focus:ring-gray-500 hover:opacity-80 hover:shadow-xl"
              ...
              <Col xs={24} md={8}>
                <button
                  type="button"
                  className="w-full h-full dark:text-white dark:bg-neutral-800 dark:border-none bg-gray-300 px-4 py-2 text-lg rounded-lg cursor-pointer outline-none ring-1 ring-gray-400 dark:ring-neutral-800 focus:ring-gray-500 hover:opacity-80 hover:shadow-xl"
              ...
              <div className="w-full flex flex-col">
                <div className="w-full relative">
                  <textarea
                    ...
                    className="w-full h-[150px] py-2 pl-4 pr-8 rounded-lg outline-none ring-1 ring-gray-400 dark:ring-neutral-800 dark:bg-neutral-800 dark:text-white focus:ring-gray-500"
                  />
                  <button
