                ...
                >
                  ...
                  >
                    <div className="flex text-center justify-center items-center mx-[10%] w-4/5 h-full overflow-hidden">
                      <h2 className="text-xl dark:text-white">{model.name}</h2>
                    </div>
                  </div>
                </Col>
              ))}
          ...
          >
            <Row className="p-8">
              ...
              <Col xs={24}>
                <button
                  type="button"
                  className="w-full bg-gray-300 rounded-lg hover:opacity-80 hover:shadow-xl py-4 m-2 dark:bg-neutral-800 dark:text-white"
