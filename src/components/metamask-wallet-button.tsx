                                ...
                                if (!connected) {
                                    return (
                                        ...
                                        <div className='bg-gray-200 dark:bg-neutral-800 rounded-lg hover:shadow-2xl text-center hover:bg-blue-600 dark:hover:bg-blue-600 duration-200 
                                                     text-white font-sans font-semibold px-2 py-2 w-full flex justify-center items-center cursor-pointer' onClick={openConnectModal}>
                                            <img className='transition-all w-[30px] cursor-pointer' src={metaIcon} alt="" />
                                        </div>
                                    );
                                }
